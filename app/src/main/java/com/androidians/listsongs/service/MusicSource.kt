...
class MusicSource {
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO) {
        ...
        val allSongs = MusicLibrary.audioList
        songs = allSongs.map { song ->
            MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_DISPLAY_ICON_URI, song.contentUri.toString())
                .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI, song.contentUri.toString())
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ART_URI, song.contentUri.toString())
                .putString(MediaMetadataCompat.METADATA_KEY_DISPLAY_SUBTITLE, song.title)
                .putString(MediaMetadataCompat.METADATA_KEY_DISPLAY_DESCRIPTION, song.title)
                .build()
        }
